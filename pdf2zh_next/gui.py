...
from pdf2zh_next.gui_advanced_pdf import create_pdf_advanced_components
from pdf2zh_next.gui_settings_builder import SaveMode
from pdf2zh_next.gui_settings_builder import build_translate_settings
from pdf2zh_next.gui_styles import load_custom_css
    ...
    *ui_args,
    ...
    try:
        ...
        for idx, file_path in enumerate(file_paths):
            ...
            translate_settings = build_translate_settings(
                settings.clone(),
                file_path,
                output_dir,
            ...
            with gr.Column(scale=1):
                ...
                with gr.Group(visible=False, elem_classes=["settings-container"]) as tab_settings:
                    ...
                    with gr.Accordion(_("Advanced Options"), open=False):
                        ...
                        # PDF / BabelDOC advanced options (extracted module)
                        _pdf_adv = create_pdf_advanced_components(settings)
                        skip_clean = _pdf_adv["skip_clean"]
                        disable_rich_text_translate = _pdf_adv["disable_rich_text_translate"]
                        enhance_compatibility = _pdf_adv["enhance_compatibility"]
                        ...
                        max_pages_per_part = _pdf_adv["max_pages_per_part"]
                        formular_font_pattern = _pdf_adv["formular_font_pattern"]
                        formular_char_pattern = _pdf_adv["formular_char_pattern"]
                        ignore_cache = _pdf_adv["ignore_cache"]
                        merge_alternating_line_numbers = _pdf_adv[
                            "merge_alternating_line_numbers"
                        ]
                        remove_non_formula_lines = _pdf_adv["remove_non_formula_lines"]
                        non_formula_line_iou_threshold = _pdf_adv[
                            "non_formula_line_iou_threshold"
                        ]
                        figure_table_protection_threshold = _pdf_adv[
                            "figure_table_protection_threshold"
                        ]
                        skip_formula_offset_calculation = _pdf_adv[
                            "skip_formula_offset_calculation"
                        ]
                        enable_post_layout_optimization = _pdf_adv[
                            "enable_post_layout_optimization"
                        ]
                        skip_header = _pdf_adv["skip_header"]
                        skip_footer = _pdf_adv["skip_footer"]
                        header_height = _pdf_adv["header_height"]
                        footer_height = _pdf_adv["footer_height"]
                        quote_narrow_threshold = _pdf_adv["quote_narrow_threshold"]
                        quote_indent_threshold = _pdf_adv["quote_indent_threshold"]
                        quote_right_margin_threshold = _pdf_adv[
                            "quote_right_margin_threshold"
                        ]
